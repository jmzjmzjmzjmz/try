...
Component.options.__file = "G:\\jmz\\projects\\try\\src\\views\\test.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-903e0f00", Component.options)
  } else {
    hotAPI.reload("data-v-903e0f00", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-903e0f00", module.exports)
  }
}
...
new Vue({
    ...
    components:{test: __WEBPACK_IMPORTED_MODULE_0__views_test_vue___default.a}
});
